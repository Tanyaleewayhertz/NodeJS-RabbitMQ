...
//     console.log(`✅ Consumer 2 waiting for messages in queue: ${q.queue}`);
...
//     );
//   } catch (error) {
//     console.error(" Error in Consumer 2:", error);
//   }
// }
...
const receiveMessages = async () => {
  try {
    ...
    channel.consume(queue.queue, (msg) => {
      if (msg.content) {
        console.log(`[x] Receiver2 received: ${msg.content.toString()}`);
      }
    }, { noAck: true });
  } catch (error) {
